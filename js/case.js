...
var arr=["image/bb1.png","image/bb2.png","image/bb3.png"];
var n=0;
var m=0;
var a=0;
...
$("#person").hover(function(){
	...
	$(".tou").css({
		background:"url(image/people1_1.png)"
	});
	$(".shen").css({
		background:"url(image/people2_1.png)"
	})
},function(){
	$("#person").css({
		background:"#FFFFFF"
	...
	$(".tou").css({
		background:"url(image/people1.png)"
	});
	$(".shen").css({
		background:"url(image/people2.png)"
	})
})
